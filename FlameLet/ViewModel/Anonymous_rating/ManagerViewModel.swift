...
class ManagerViewModel: ObservableObject {
    ...
    func loadData() {
            guard let url = URL(string: "http://10.89.96.129:8081/fetchmanager") else {
