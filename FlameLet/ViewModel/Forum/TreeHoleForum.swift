...
//        for post in self.posts {
//            if post.dependency != post._id {
//                for postPage in self.pages {
//                    if post._id == postPage.id {
//                        postPage.addPost(post: post)
//                    }
//                }
//            }
//        }
...
//    func addPost(title: String, content: String, poster: String) {
//        let newPost = Post(title: title, content: content, poster: poster)
//        newPost.assignDependency(dependency: newPost._id)
